...
export abstract class IMessageReceiver
  extends EventTarget
  implements IRequestHandler
{
  public abstract handleRequest(request: IncomingWebSocketRequest): void;
  public abstract getAndResetProcessedCount(): number;
  public abstract reset(): void;
  public abstract stopProcessing(): void;
  public abstract hasEmptied(): boolean;
